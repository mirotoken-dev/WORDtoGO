...
const rawData: Omit<LetterData, "color">[] = [
  ...
  },
  {
    ...
    words: [
      ...
      { word: "Oven", emoji: "/assets/oven-icon.png", arabic: "فرن" },
      { word: "Ocean", emoji: "🌊", arabic: "محيط" },
      { word: "Oil", emoji: "🛢️", arabic: "زيت" },
      { word: "Office", emoji: "/assets/office-icon.png", arabic: "مكتب" },
