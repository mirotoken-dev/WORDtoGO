  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "oklch(0.98 0.02 60)" }}>
      ...
      <div
        ...
        style={{ background: "linear-gradient(160deg, oklch(0.70 0.22 40) 0%, oklch(0.60 0.22 40) 100%)" }}
      >
        <motion.div
        ...
        >
          ...
          <h1 className="text-5xl font-display font-black leading-tight text-white drop-shadow">
            Word<br />to Go
          </h1>
      ...
      <div className="flex-1 px-5 py-6 flex flex-col gap-4">
        ...
        {profiles.map((profile, idx) => (
          <motion.div
            ...
            className="flex items-center gap-4 bg-white rounded-3xl px-4 py-4 border"
          ...
          >
            ...
            >
              <div
                className="w-16 h-16 text-4xl flex items-center justify-center rounded-2xl flex-shrink-0"
                style={{ background: "oklch(0.94 0.06 40)" }}
              >
                {profile.avatar}
              </div>
        ...
        <AnimatePresence>
          {profiles.length >= 3 && !creating ? (
            <motion.div
              ...
              className="text-center py-4 px-5 rounded-3xl bg-white border"
            ...
            >
              ...
              <div className="mb-4">
                <label htmlFor="profile-name" className="block text-sm font-display font-semibold text-foreground mb-2">
                  Name
                </label>
                <input
                  id="profile-name"
                  ...
                  className="w-full px-4 py-3 rounded-2xl border bg-muted text-foreground font-body text-lg placeholder:text-muted-foreground focus:outline-none"
                ...
                <div className="grid grid-cols-5 gap-2">
                  {AVATARS.map((a) => (
                    <button
                      ...
                      style={{
                        borderColor: avatar === a ? "oklch(0.68 0.22 40)" : "transparent",
                        background: avatar === a ? "oklch(0.94 0.06 40)" : "oklch(0.94 0.02 60)",
                      }}
                    >
                      {a}
                    </button>
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-4 rounded-2xl bg-muted font-display font-bold text-foreground active:scale-95 transition-smooth border"
                  style={{ borderColor: "oklch(0.90 0.02 60)" }}
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={!name.trim()}
                  className="flex-1 py-4 rounded-2xl font-display font-bold text-white active:scale-95 transition-smooth disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <motion.button
              ...
              className="w-full py-5 rounded-3xl border-2 border-dashed font-display font-bold text-lg flex items-center justify-center gap-2 active:scale-95 transition-smooth"
              style={{ borderColor: "oklch(0.78 0.14 40)", color: "oklch(0.68 0.22 40)" }}
              whileTap={{ scale: 0.97 }}
            >
              + Add New Learner
            </motion.button>
